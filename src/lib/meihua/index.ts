// 梅花易數 · 後天數推斷 (Phase C v1)
  // 根據 馬號/檔位/馬名筆畫/騎師筆畫/時辰 起 上卦/下卦/動爻 → 本卦+變卦+體用 → 評分
  ...
  export function meihuaScoreForHorse(input: MeihuaInput): MeihuaScore {
    ...
    // 動爻在下卦(1-3)→ 用為下卦, 體為上卦; 動爻在上卦(4-6)→ 用為上卦, 體為下卦
